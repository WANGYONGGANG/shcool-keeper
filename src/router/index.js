...
import ClassReportListDetial from '@/components/chart/classReportListDetial'
...
import intentionCourseStepTwo from '@/components/teacher/intentionCourseStepTwo'
...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/intentionCourseStepTwo',
      name: 'intentionCourseStepTwo',
      component: intentionCourseStepTwo
    },
    {
      path: '/user/blank',
      name: 'blank',
    ...
    {
      path: '/chart/classReportListDetial',
      name: 'classReportListDetial',
      component: ClassReportListDetial
    },
    {
